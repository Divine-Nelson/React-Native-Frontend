...
export const productData = [
    { id: 1, name: "Hex Hantel", image: require('../assets/massage gun 9.jpg'), price: 100, currency: "kr", deal: false, category: "Massage Gun", description: "High-quality hexagonal dumbbell for versatile workouts, designed to provide a firm grip and ensure durability over time.", quantityAvailable: 35 },
    { id: 2, name: "Abilica Dumbbell", image: require('../assets/Massage gun 6.png'), price: 100, currency: "kr", deal: false, category: "Massage Gun", description: "Durable Abilica dumbbell for strength training, perfect for home or gym use and crafted for superior performance.", quantityAvailable: 35 },
    { id: 3, name: "Abilica Dumbbell", image: require('../assets/massage gun 5.webp'), price: 100, currency: "kr", deal: false, category: "Massage Gun", description: "Compact and ergonomic Abilica dumbbell, ideal for a variety of strength exercises and easy to store.", quantityAvailable: 35 },
    { id: 4, name: "Rubber Hex Dumbbells", image: require('../assets/Massage gun 6.png'), price: 100, currency: "kr", deal: false, category: "Massage Gun", description: "Rubber-coated hex dumbbells for noise reduction, designed to protect your floors and enhance workout safety.", quantityAvailable: 35 },
    { id: 5, name: "Rubber Hex Dumbbells", image: require('../assets/massage gun 7.webp'), price: 100, currency: "kr", deal: false, category: "Massage Gun", description: "Durable and versatile hex dumbbells, suitable for both beginners and experienced fitness enthusiasts.", quantityAvailable: 35 },
    { id: 6, name: "Rubber Hex Dumbbells", image: require('../assets/massage gun 8.jpg'), price: 100, currency: "kr", deal: false, category: "Massage Gun", description: "Premium rubber hex dumbbells for strength training, featuring an ergonomic design for maximum comfort.", quantityAvailable: 35 },
    { id: 7, name: "Rubber Hex Dumbbells", image: require('../assets/massage gun 12.jpg'), price: 100, currency: "kr", deal: true, category: "Massage Gun", description: "High-performance dumbbells on special deal, offering exceptional value and durability for your workouts.", quantityAvailable: 35 },
    { id: 20, name: "Rubber Hex Dumbbells", image: require('../assets/massage gun 10.webp'), price: 100, currency: "kr", deal: true, category: "Massage Gun", description: "Affordable rubber hex dumbbells on sale, designed for effective strength training and long-term use.", quantityAvailable: 35 },
